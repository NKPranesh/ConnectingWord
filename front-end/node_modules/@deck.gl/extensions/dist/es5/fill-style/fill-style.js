...
class FillStyleExtension extends _core.LayerExtension {
  constructor({
    pattern = false
  } = {}) {
    super({
  ...
  async loadPatternAtlas({
    ...
    const patternTexture = image instanceof _core2.Texture2D ? image : new _core2.Texture2D(this.context.gl, {
      data: image,
