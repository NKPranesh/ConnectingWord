...
class GoogleMapsOverlay {
  ...
  _onContextRestored(gl) {
    ...
    const deck = (0, _utils.createDeckInstance)(this._map, this._overlay, this._deck, {
      gl,
      _customRender,
      ...this.props
    });
  ...
  _onDrawRaster() {
    ...
    const {
      ...
      latitude,
      longitude
    } = (0, _utils.getViewPropsFromOverlay)(this._map, this._overlay);
  ...
  _onDrawVector(gl, coordinateTransformer) {
    ...
    const deck = this._deck;
    deck.setProps({ ...(0, _utils.getViewPropsFromCoordinateTransformer)(this._map, coordinateTransformer)
    });

    if (deck.layerManager) {
      const _framebuffer = (0, _core.getParameters)(gl, 36006);
      ...
      (0, _core.withParameters)(gl, GL_STATE, () => {
