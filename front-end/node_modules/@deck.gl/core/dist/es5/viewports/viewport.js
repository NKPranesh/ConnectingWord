...
class Viewport {
  ...
  _getCenterInWorld({
    ...
    const center = new _math.Vector3(this.projectPosition([longitude, latitude, 0]));

    if (meterOffset) {
      const commonPosition = new _math.Vector3(meterOffset).scale(distanceScales.unitsPerMeter);
