...
function toHilbertQuadkey(idS) {
  let bin = _long.default.fromString(idS, true, 10).toString(2);
  ...
  const faceS = _long.default.fromString(faceB, true, 2).toString(10);

  let posS = _long.default.fromString(posB, true, 2).toString(4);
