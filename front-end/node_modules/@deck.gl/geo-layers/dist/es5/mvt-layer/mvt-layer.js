...
class MVTLayer extends _tileLayer.default {
  initializeState() {
  ...
  getTileData(tile) {
    ...
    const url = (0, _utils.getURLFromTemplate)(this.state.data, tile);
  ...
  renderSubLayers(props) {
    ...
    const modelMatrix = new _math.Matrix4().scale([xScale, yScale, 1]);
    ...
    if (!this.context.viewport.resolution) {
      ...
      props.extensions = [...(props.extensions || []), new _extensions.ClipExtension()];
    }
        ...
        Object.defineProperty(tile, propName, {
          get: () => {
            ...
            if (tile._contentWGS84 === undefined) {
              const content = this.props.binary ? (0, _gis.binaryToGeojson)(tile.content) : tile.content;
...
function transformTileCoordsToWGS84(object, bbox, viewport) {
  ...
  Object.defineProperty(feature.geometry, 'coordinates', {
    get: () => {
      const wgs84Geom = (0, _coordinateTransform.transform)(object.geometry, bbox, viewport);
